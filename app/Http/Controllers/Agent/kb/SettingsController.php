...
class SettingsController extends Controller
{
    ...
    public function getData()
    {
        return \Datatable::collection(Comment::All())
                        ...
                        ->addColumn('Actions', function ($model) {
                            return '<div class="row"><div class="col-md-6"><a href=comment/delete/'.$model->id.' class="btn btn-danger btn-xs">'.\Lang::get('lang.delete').'</a></div><div class="col-md-6"><a href=published/'.$model->id.' class="btn btn-warning btn-xs">'.\Lang::get('lang.publish').'</a></div></div>';
                        })
                        ->make();
    }
