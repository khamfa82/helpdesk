...
<html>
    <head>
        ...
        {{-- Custom bootstrap modifications initiated by Ali A. Saleh --}}
        <link type="text/css" href="{{asset("css/bootstrap-custom.css")}}" rel="stylesheet">
                ...
                <nav class="navbar navbar-static-top">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-collapse">
                        ...
                        <ul class="tabs tabs-horizontal nav navbar-nav navbar-left">
                            <li @yield('Dashboard')><a id="dash" data-target="#tabA" href="{{URL::route('dashboard')}}" onclick="clickURL(event, '{{URL::route('dashboard')}}');">{!! Lang::get('lang.dashboard') !!}</a></li>
                            <?php /*
                            ...
                            */ ?>
                            ...
                            <li @yield('Report')><a data-target="#tabE" href="#">Report</a></li>
                            @if (auth()->user()->can_view_tasks)
                                <li @yield('Tasks') class="bg-green"><a href="/tasks" onclick="clickURL(event, '/tasks');">{!! Lang::get('lang.tasks') !!}</a></li>
                            @endif
                    ...
                    <ul id="side-bar" class="sidebar-menu">
                        ...
                        <li @yield('inbox')>
                             <a href="{{ url('tickets')}}" id="load-inbox">
                                <i class="fa fa-envelope"></i> <span>{!! Lang::get('lang.inbox') !!}</span> <small class="label pull-right bg-green">{{ count($tickets) }}</small>
                            </a>
                        </li>
                        <li @yield('myticket')>
                        ...
                        <li @yield('unassigned')>
                            <a href="{{url('/tickets?show=unassigned')}}" id="load-unassigned">
                        ...
                        @if (auth()->user()->management_level != 1)
                            <li @yield('escalated')>
                                <a href="{{url('/tickets?show=escalated')}}" id="load-escalated">
                                    <i class="fa fa-arrow-up"></i> <span>{!! Lang::get('lang.escalated') !!}</span>
                                    <small class="label pull-right bg-green">{{ \App\Model\helpdesk\Ticket\Tickets::getEscalatedTicketCount() }}</small>
                                </a>
                            </li>
                       @endif
                        ...
                        <li @yield('overdue')>
                             <a href="{{url('/tickets?show=overdue')}}" id="load-unassigned">
                                ...
                                <small class="label pull-right bg-green">{{ count($overdues) }}</small>
                            </a>
                        </li>
                        ...
                        <div class="tabs-content">
                            ...
                            <div class="tabs-pane @yield('tools-bar')" id="tabD">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li id="bar" @yield('kb')><a href="{{ url('/comment')}}" >{!! Lang::get('lang.knowledge_base') !!}</a></li> <?php /*TODO: fIX kb */ ?>
                                    @endif
                                </ul>
                            </div>
                            ...
                            <div class="tabs-pane @yield('report-bar')" id="tabE">
                                <ul class="nav navbar-nav">
                                    @if($auth_user_role == 'admin')
                                        <li id="bar" ><a href="{{URL::route('report.index')}}" >General Report</a></li>
                                        <li id="bar" ><a href="{{URL::route('report.user')}}" >All Users Report</a></li> <?php /*TODO: IMPLEMENT USER REPORT */ ?>
                                        <li id="bar" ><a href="{{URL::route('report.open')}}" >Detailed Tickets Report</a></li> <?php /*TODO: IMPLEMENT USER REPORT */ ?>
                                        <li id="bar" ><a href="{{URL::route('report.crm')}}" >CRM Report Overview</a></li> <?php /*TODO: IMPLEMENT USER REPORT */ ?>
                                        <li id="bar" ><a href="{{URL::route('report.graphical-reports')}}" >Detailed Graphical Reports</a></li> <?php /*TODO: IMPLEMENT USER REPORT */ ?>
                                    @endif
                                        <li id="bar" ><a href="{{URL::route('report.user.show',[Auth::user()->id])}}" >My Report</a></li> <?php /*TODO: IMPLEMENT USER REPORT */ ?>
...
<?php \Event::dispatch('service.desk.agent.topsubbar', array()); ?>
                ...
                <?php //dd(env('SUPPRESS_EMAIL_WARNING')); ?>
                    ...
                    @if(env('SUPPRESS_EMAIL_WARNING', 'false'))
                    @endif
                    <div class="row">
                        <div class="col-md-12">
