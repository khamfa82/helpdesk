...
<div class="box box-info">
    <div class="box-header with-border">
        <h3 class="box-title">{!! Lang::get('lang.filter') !!} {!! Lang::get('lang.my') !!} {!! Lang::get('lang.reports') !!}: {{ auth()->user()->first_name . " " . auth()->user()->last_name . " <" . auth()->user()->email . ">" }}</h3>
    </div>
    <div class="box-body">
        <form id="foo">
            ...
            <div  class="form-group">
                <div class="row">
                    {{-- Assigned Users --}}
                    <div class='col-sm-2' style="margin-top: 30px !important;">
                        <input 
                            type="checkbox" 
                            @if(old('assigned_user') == auth()->user()->id) checked @endif
                            name="assigned_user"
                            value="{{ auth()->user()->id }}"
                            id="assigned_user"
                        /> 
                        <label for="assigned_user">
                            {!! Lang::get('lang.as') . " " . Lang::get('lang.assigned_user') !!}
                        </label>
                    </div>
                    ...
                    <div class='col-sm-2' style="margin-top: 30px !important;">
                        <input 
                            type="checkbox" 
                            @if(old('thread_user') == auth()->user()->id) checked @endif 
                            name="thread_user" 
                            value="{{ auth()->user()->id }}"
                            id="thread_user"
                        /> 
                        <label for="thread_user">
                            {!! Lang::get('lang.as') . " " . Lang::get('lang.thread_user') !!}
                        </label>
                    </div>
                    {{--  --}}
                ...
                @else
                        <tr class="bg-danger">
                            <td colspan="7" class="text-center">
                                <b>
                                    No reports found, please filter to see more reports!
                                </b>
                            </td>
                        </tr>
                @endif
