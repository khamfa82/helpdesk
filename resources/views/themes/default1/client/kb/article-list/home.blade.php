                ...
                <h1 class="section-title h4 clearfix">
                    ...
                    <small class="pull-right">
                      <a href="{{url('category-list/'.$category->slug)}}">
                        <i class="fa fa-hdd-o fa-fw"></i>({{ $count }})
                      </a>
                    </small>
                    <a href="{{url('category-list/'.$category->slug)}}">
                      {{$category->name}}
                ...
                <ul class="fa-ul" style="min-height:150px">
                    ...
                    foreach ($article_id as $id) {
                        ...
                        <li>
                            ...
                            <h3 class="h5"><a href="#"><a href="{{url('show/'.$arti->slug)}}"> <b>{{$arti->name}}</b></a></h3>
                            ...
                            //echo strip_tags($excerpt); ?>
                              <!--<br/>
                            <a class="more-link text-center" href="{{url('show/'.$arti->slug)}}" style="color: orange">
