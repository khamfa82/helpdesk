                ...
                <div class="container" style="">
                    <div id="logo" class="site-logo text-center" style="font-size: 30px;">
                        ...
                        <?php if($company->use_logo == 1): ?>
                            ...
                            <?php /* <img src="{{asset('lb-faveo/media/images/logo.png')}}" alt="User Image" width="200px" height="200px"/> */ ?>
                            
                        <?php endif; ?>

                        <?php if($system->name): ?>
                            <b><?php echo $system->name; ?></b>
                        <?php else: ?>
                            <b>SUPPORT</b> CENTER
                        <?php endif; ?>
                    ...
                    <div id="navbar" class="navbar-wrapper text-center">
                        <nav class="navbar navbar-default site-navigation" role="navigation">
                            <ul class="nav navbar-nav navbar-menu">
                                <li <?php echo $__env->yieldContent('home'); ?>><a href="<?php echo e(url('/')); ?>"><?php echo Lang::get('lang.home'); ?></a></li>
                                <?php if($system->first()->status == 1): ?>
                                <li <?php echo $__env->yieldContent('submit'); ?>><a href="<?php echo e(URL::route('form')); ?>"><?php echo Lang::get('lang.submit_a_ticket'); ?></a></li>
                                <?php endif; ?>
                            ...
                            <ul class="nav navbar-nav navbar-login">
                                ...
                                if (is_object($errors)) {
                                    ...
                                    ?>
                                    data-target="#login-form"><?php echo Lang::get('lang.login'); ?> <i class="sub-indicator fa fa-chevron-circle-down fa-fw text-muted"></i></a></li>
                            </ul><!-- .navbar-login -->
                            <?php endif; ?>
                            <div id="login-form" <?php if(isset($errors)): ?><?php if ($errors->first('email') || $errors->first('password')) { ?> class="login-form collapse fade clearfix in" <?php } else { ?> class="login-form collapse fade clearfix" <?php } ?><?php endif; ?> >
                                 <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <?php b: ?>
                                        <?php endif; ?>
                                        <div class="form-group has-feedback <?php if(isset($errors)): ?> <?php echo $errors->has('email') ? 'has-error' : ''; ?> <?php endif; ?>">
                                            <?php echo Form::text('email',null,['placeholder'=>Lang::get('lang.e-mail'),'class' => 'form-control']); ?>

                                            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                                        </div>
                                        <div class="form-group has-feedback <?php if(isset($errors)): ?> <?php echo $errors->has('password') ? 'has-error' : ''; ?> <?php endif; ?>">
                                            ...
                                            <a href="<?php echo e(url('password/email')); ?>" style="font-size: .8em" class="pull-left"><?php echo Lang::get('lang.forgot_password'); ?></a>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-custom  .btn-sm "><?php echo Lang::get('lang.login'); ?></button>
                                        <?php echo Form::close(); ?>

                                        </div>
                                    </div>
                                    <?php echo e(Lang::get('lang.or')); ?>

                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="list-unstyled">
                                            <a href="<?php echo e(url('auth/register')); ?>" style="font-size: 1.2em"><?php echo Lang::get('lang.create_account'); ?></a>
                                        </ul>
                                    </div>
                                </div>
                                </div>
...
<?php /*
                    ...
                    <div id="header-search" class="site-search clearfix" style="padding-bottom:5px"><!-- #header-search -->
                        <?php echo Form::open(['method'=>'get','action'=>'Client\kb\UserController@search','class'=>'search-form clearfix']); ?>

                        <div class="form-border">
                            <div class="form-inline ">
                                <div class="form-group">
                                    <input type="text" name="s" class="search-field form-control input-lg" title="Enter search term" placeholder="<?php echo Lang::get('lang.have_a_question?_type_your_search_term_here'); ?>" required/>
                                </div>
                                <button type="submit" class="search-submit btn btn-custom btn-lg pull-right"><?php echo Lang::get('lang.search'); ?></button>
                            </div>
                        </div>
                        <?php echo Form::close(); ?>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="site-info col-md-6">
                            <p class="text-muted"><?php echo Lang::get('lang.copyright'); ?> &copy; <?php echo date('Y'); ?>  <a href="<?php echo $company->website; ?>" target="_blank"><?php echo $company->company_name; ?></a>.
                        ...
                        <div class="site-social text-right col-md-6">
                            ...
                            <ul class="list-inline hidden-print">
                                ...
                                <?php endif; ?>
                                <?php endif; ?>
                                <?php if($social->name == "skype"): ?>
                                <?php if($social->value): ?>
                                <li><a href="<?php echo e($social->value); ?>" class="btn btn-social btn-twitter" target="_blank"><i class="fa fa-skype fa-fw"></i></a></li>
                                <?php endif; ?>
                                <?php endif; ?>
                                <?php if($social->name == "stumble"): ?>
                                <?php if($social->value): ?>
                                <li><a href="<?php echo e($social->value); ?>" class="btn btn-social btn-google-plus" target="_blank"><i class="fa fa-stumbleupon fa-fw"></i></a></li>
                                <?php endif; ?>
                                <?php endif; ?>
                                <?php if($social->name == "deviantart"): ?>
                                <?php if($social->value): ?>
                                <li><a href="<?php echo e($social->value); ?>" class="btn btn-social btn-success" target="_blank"><i class="fa fa-deviantart fa-fw"></i></a></li>
                                <?php endif; ?>
                                <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
...
<?php /**PATH F:\xampp\htdocs\helpdesk\resources\views/themes/default1/client/layout/client.blade.php ENDPATH**/ ?>