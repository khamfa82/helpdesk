...
<h1><?php echo Lang::get('lang.dashboard_reports'); ?></h1>
<?php $__env->stopSection(); ?>
...
<?php endif; ?>
<link type="text/css" href="<?php echo e(asset("lb-faveo/css/bootstrap-datetimepicker4.7.14.min.css")); ?>" rel="stylesheet">
...
<div class="row">
        ...
        <a href="<?php echo url('tickets'); ?>">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <span class="info-box-text"><?php echo Lang::get('lang.inbox'); ?></span>
                    <span class="info-box-number"><?php echo count($tickets) ?> <small> <?php echo Lang::get('lang.tickets'); ?></small></span>
    ...
    <!-- <div class="col-md-3 col-sm-6 col-xs-12"> -->
    <div class="col-md-2" style="width:20%;">
        <!-- <a href="<?php echo url('/tickets?assigned[]=0'); ?>"> -->
        <a href="<?php echo url('/tickets?show=unassigned'); ?>">
            <div class="info-box">
                <span class="info-box-icon bg-orange"><i class="fa fa-user-times"></i></span>
                <div class="info-box-content">
                    <span class="info-box-text"><?php echo Lang::get('lang.unassigned'); ?></span>
                    <span class="info-box-number"><?php echo e(count($unassigned)); ?> <small> <?php echo Lang::get('lang.tickets'); ?></small></span>
                </div><!-- /.info-box-content -->
            </div><!-- /.info-box -->
        </a>
    </div><!-- /.col -->
    ...
    <!-- <div class="col-md-3 col-sm-6 col-xs-12"> -->
    <div class="col-md-2" style="width:20%;">
        <a href="<?php echo url('/tickets?show=overdue'); ?>">
            <div class="info-box">
                <span class="info-box-icon bg-red"><i class="fa fa-calendar-times-o"></i></span>
                <div class="info-box-content">
                    <span class="info-box-text"><?php echo Lang::get('lang.overdue'); ?></span>
                    <span class="info-box-number"><?php echo e(count($overdues)); ?> <small> Tickets</small></span>
                </div><!-- /.info-box-content -->
            </div><!-- /.info-box -->
        </a>
    </div><!-- /.col -->
    <!-- <div class="col-md-3 col-sm-6 col-xs-12"> -->
    <div class="col-md-2" style="width:20%;">
        <a href="<?php echo url('/tickets?show=mytickets'); ?>">
            <div class="info-box">
                <span class="info-box-icon bg-yellow"><i class="fa fa-user"></i></span>
                <div class="info-box-content">
                    <span class="info-box-text"><?php echo Lang::get('lang.my_tickets'); ?></span>
                    <span class="info-box-number"><?php echo e(count($myticket)); ?> <small> Tickets</small></span>
                </div><!-- /.info-box-content -->
            </div><!-- /.info-box -->
        </a>
    </div><!-- /.col -->
     ...
     $todaytickets = App\Model\helpdesk\Ticket\Tickets::where('status', '=', 1)->whereDate('tickets.duedate','=', \Carbon\Carbon::now()->format('Y-m-d'))->where('dept_id', '=', $dept->id)->count();
      ...
      ?>
                 <a href="<?php echo url('/tickets?show%5B%5D=due_today'); ?>">
            <div class="info-box">
                <span class="info-box-icon bg-red"><i class="glyphicon glyphicon-eye-open"></i></span>
                <div class="info-box-content">
                    <span class="info-box-text"><?php echo Lang::get('lang.duetoday'); ?></span>
                    <span class="info-box-number"><?php echo e($todaytickets); ?> <small> Tickets</small></span>
                </div><!-- /.info-box-content -->
            </div><!-- /.info-box -->
        </a>
          <!-- /.info-box -->
...
<div class="box box-info">
    <div class="box-header with-border">
        <h3 class="box-title"><?php echo Lang::get('lang.report'); ?></h3>
    </div>
    <div class="box-body">
        <form id="foo">
            <div  class="form-group">
                <div class="row">
                    <div class='col-sm-2'>
                        <?php echo Form::label('date', 'Start Date:',['class' => 'lead']); ?>

                        <?php echo Form::text('start_date',null,['class'=>'form-control','id'=>'datepicker4']); ?>
                    ...
                    <script type="text/javascript">
                        $(function () {
                            var timestring1 = "<?php echo $start_date; ?>";
                            var timestring2 = "<?php echo date('m/d/Y'); ?>";
                    ...
                    <div class='col-sm-2'>
                        <?php echo Form::label('start_time', 'End Date:' ,['class' => 'lead']); ?>

                        <?php echo Form::text('end_date',null,['class'=>'form-control','id'=>'datetimepicker3']); ?>
                    ...
                    <div class='col-sm-1'>
                        <?php echo Form::label('filter', 'Filter:',['class' => 'lead']); ?><br>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2" style="margin-bottom:-20px;">
                        <label class="lead"><?php echo Lang::get('lang.Legend'); ?>:</label>
                    </div>
                    <style>
                        #legend-holder { border: 1px solid #ccc; float: left; width: 25px; height: 25px; margin: 1px; }
                    </style>
                    <div class="col-md-3"><span id="legend-holder" style="background-color: #6C96DF;"></span>&nbsp; <span class="lead"> <span id="total-created-tickets" ></span> <?php echo Lang::get('lang.tickets'); ?> <?php echo Lang::get('lang.created'); ?></span></div>
                    <div class="col-md-3"><span id="legend-holder" style="background-color: #6DC5B2;"></span>&nbsp; <span class="lead"> <span id="total-reopen-tickets" class="lead"></span> <?php echo Lang::get('lang.tickets'); ?> <?php echo Lang::get('lang.reopen'); ?></span></div>
                    <div class="col-md-3"><span id="legend-holder" style="background-color: #E3B870;"></span>&nbsp; <span class="lead"> <span id="total-closed-tickets" class="lead"></span> <?php echo Lang::get('lang.tickets'); ?> <?php echo Lang::get('lang.closed'); ?></span></div>
                </div>
            </div>
        </form>
...
<div class="box">
    <div class="box-header with-border  ">
        <h1 class="box-title"><?php echo Lang::get('lang.statistics'); ?></h1>
    </div>
    <div class="box-body">
...
//            dd($department);
            ...
            <tr>
                ...
                <?php if($dept->get($status)): ?>
                 <th><?php echo $dept->get($status)->count; ?></th>
                <?php else: ?>
                    <th></th>
                 <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<div id="refresh">
    <script src="<?php echo e(asset("lb-faveo/plugins/chartjs/Chart.min.js")); ?>" type="text/javascript"></script>
</div>
<script src="<?php echo e(asset("lb-faveo/plugins/chartjs/Chart.min.js")); ?>" type="text/javascript"></script>
<script type="text/javascript">
...
<script src="<?php echo e(asset("lb-faveo/plugins/moment-develop/moment.js")); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset("lb-faveo/js/bootstrap-datetimepicker4.7.14.min.js")); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('themes.default1.agent.layout.agent', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\helpdesk\resources\views/themes/default1/agent/helpdesk/dashboard/dashboard.blade.php ENDPATH**/ ?>